module Spree
  class Gateway::Worldpay < Gateway
    ...
    attr_accessible :preferred_installation_id

    attr_accessible :preferred_american_express_login
    attr_accessible :preferred_discover_login
    attr_accessible :preferred_jcb_login
    attr_accessible :preferred_maestro_login
    attr_accessible :preferred_mastercard_login
    attr_accessible :preferred_visa_login
